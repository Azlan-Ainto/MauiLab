...
namespace DontLeMeExpire.Services
{
    ...
    {
        public static List<Lager> Orte { get; } = [
        ...
        public static List<Produkt> Produkte { get; } = [
            ...
            new Produkt {
                ...
                LagerID = "2c3d4e5f-6a7b-46f7-3489-abcdef012345", // Obstschale
                Foto = "aepfel.png",
                Menge = 6.0m
            },
            new Produkt {
            ...
            new Produkt {
                ...
                LagerID = "3d4e5f6a-7b8c-47a8-4590-bcdef0123456", // Brotkasten
                Foto = "brot.png",
                Menge = 1.0m
            },
            new Produkt {
            ...
            new Produkt {
                ...
                Verfallsdatum = DateTime.Now.AddYears(1),
                LagerID = "e6f7a8b9-c0d1-42b3-f045-6789abcdef01", // Getränkekiste
                Foto = "wasser.png",
                Menge = 12.0m
            },
            new Produkt {
            ...
            new Produkt {
                ...
                LagerID = "b3c4d5e6-f7a8-49e0-cd12-3456789abcde", // Keller
                Foto = "kartoffeln.png",
                Menge = 5.0m
            },
            new Produkt {
